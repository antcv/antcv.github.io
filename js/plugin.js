        ...
        var a = Math.PI / 180,
            ...
            p = function(a) {
                ...
                for (k = 0; h > k; k++)
                    ...
                    if (x = o(e, g, 1 * b[k + 1], 1 * b[k + 2], 1 * b[k + 3], 1 * b[k + 4], 1 * b[k + 5], (r ? e : 0) + 1 * b[k + 6], (r ? g : 0) + 1 * b[k + 7])) {
                        for (l = 0; l < x.length; l++) s[i++] = x[l];
                        e = s[i - 2], g = s[i - 1]
                    }
                    k += 7
            ...
            O = _gsScope._gsDefine.plugin({
                ...
                init: function(a, b, c, d) {
                    var f, g, n, o, p;
                    return "function" != typeof a.setAttribute ? !1 : ("function" == typeof b && (b = b(d, a)), l ? (f = a.nodeName.toUpperCase(), p = "POLYLINE" === f || "POLYGON" === f, "PATH" === f || p ? (g = "PATH" === f ? "d" : "points", ("string" == typeof b || b.getBBox || b[0]) && (b = {
                        shape: b
                    }), o = M(b.shape || b.d || b.points || "", "d" === g, a), p && e.test(o) ? (m("WARNING: a <" + f + "> cannot accept path data. " + N), !1) : (o && (this._target = a, a.getAttributeNS(null, "data-original") || a.setAttributeNS(null, "data-original", a.getAttribute(g)), n = this._addTween(a, "setAttribute", a.getAttribute(g) + "", o + "", "morphSVG", !1, g, "object" == typeof b.precompile ? function(a) {
                        a[0] = b.precompile[0], a[1] = b.precompile[1]
                    } : "d" === g ? F(b.shapeIndex, b.map || O.defaultMap, b.precompile) : J(b.shapeIndex)), n && (this._overwriteProps.push("morphSVG"), n.end = o, n.endProp = g)), l)) : (m("WARNING: cannot morph a <" + f + "> SVG element. " + N), !1)) : (window.location.href = "http://" + j + k + "?plugin=" + i + "&source=" + h, !1))
                },
                set: function(a) {
                    var b;
